...
class AttestationController extends Controller {
    ...
    public function percepteurAction($page) {
        ...
        return $this->render('PoliceBundle:Attestation:percepteur.html.twig', array(
                    'attestations' => $attestations,
                    'page' => $page,
                    'nbrTotalPages' => $nbrTotalPages,
        ));
    ...
    public function pdfAction(){
     ...
     $snappy = $this->get('knp_snappy.pdf');
         ...
         $html = $this->renderView('PoliceBundle:Attestation:pdf.html.twig', array(
            'title' => 'Hello World !'
        ));
    ...
    public function listeInfractionAction($id, Request $request){
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
         ...
         return $this->render('PoliceBundle:Attestation/agent_circulation:liste_infraction.html.twig', array(
                    'form' => $form->createView(),
                    'id' => $infraction->getAttestation()->getId()
        ));
